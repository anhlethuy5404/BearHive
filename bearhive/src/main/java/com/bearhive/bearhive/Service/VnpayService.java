...
import com.bearhive.bearhive.Config.VnpayConfig;
...
public class VnpayService {
    public String createPayment(VnpayRequest paymentRequest) throws UnsupportedEncodingException {
        ...
        long amount = 0;
        try {
            amount = Long.parseLong(paymentRequest.getAmount()) * 100; // Chuyển đổi sang đồng xu (VND)
        } catch (NumberFormatException e) {
            throw new IllegalArgumentException("Số tiền không hợp lệ");
        }

        String bankCode = "NCB";
        String vnp_TxnRef = paymentRequest.getOrderId() != null ? 
